...
@Component 
  ...
  public String createtoken(Long id) { try {
  
  Algorithm algorithm=Algorithm.HMAC256(SECRET_TOKEN);    //HS256(SECRET_TOKEN);
  ...
  public Long decodetoken(String token) { Long user_id;
